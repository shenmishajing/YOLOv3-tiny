...
/*                cvNamedWindow("predictions", CV_WINDOW_NORMAL); 
            ...
            int m = plist->size;
            if(access("/home/zmart/Project/darknet/data/out",0)==-1)//"/home/FENGsl/darknet/data"修改成自己的路径
            {
              if (mkdir("/home/zmart/Project/darknet/data/out",0777))//"/home/FENGsl/darknet/data"修改成自己的路径
               {
        ...
        if(outfile){
            save_image(im, outfile);
             ...
             char b[2048];
            sprintf(b,"/home/zmart/Project/darknet/data/out/%s",GetFilename(path));//"/home/FENGsl/darknet/data"修改成自己的路径
